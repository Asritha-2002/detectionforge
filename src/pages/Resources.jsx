            ...
            >
              <div className="flex flex-col gap-3 sm:flex-row">
                <input
                  ...
                  className="h-11 flex-1 rounded-md border border-border bg-surface px-4 py-3 text-sm text-foreground placeholder:text-muted-foreground focus:border-teal/40 focus:outline-none focus:ring-1 focus:ring-teal/40"
                />
                <button
                  type="submit"
